...
console.log('Request 1:', animalNames());
  ...
  */
  ...
  function USApop(){
    const needPop = zooAnimals.reduce((acc, item) => acc + item.population, 0);
    return needPop;
  }
...
function greeting(first, last){
  ...
  console.log('Step 3 Test:', consume(2, 2, add)); // 4
  console.log('Step 3 Test:', consume(10, 16, multiply)); // 160
  console.log('Step 3 Test:', consume("Mary", "Poppins", greeting)); // Hello Mary Poppins, nice to meet you!
